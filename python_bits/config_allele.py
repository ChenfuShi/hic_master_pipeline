...
class Config:
    ...
    def __init__(self):
        ...
        self.Trimmed_dir = "/mnt/iusers01/jw01/mdefscs4/scratch/master_HiC_analyzer_allele/temp_trimming"
        self.Matrix_dir = "/mnt/iusers01/jw01/mdefscs4/scratch/master_HiC_analyzer_allele/temp_matrix"
        self.HiC_pro_outs_dir = "/mnt/iusers01/jw01/mdefscs4/scratch/master_HiC_analyzer_allele/hic-pro_outputs"
        self.HiC_pro_temp_dir = "/mnt/iusers01/jw01/mdefscs4/scratch/master_HiC_analyzer_allele/hic-pro_outputs_temp"
        self.Juicebox_dir = "/mnt/iusers01/jw01/mdefscs4/scratch/master_HiC_analyzer_allele/juiceboxes"
        self.cool_dir = "/mnt/iusers01/jw01/mdefscs4/scratch/master_HiC_analyzer_allele/cool"
        self.TADs_dir = "/mnt/iusers01/jw01/mdefscs4/scratch/master_HiC_analyzer_allele/TADs"
        self.Reads_quality_dir = "/mnt/iusers01/jw01/mdefscs4/scratch/master_HiC_analyzer_allele/fastp_reports"
        ...
        self.compartments_loc = "/mnt/iusers01/jw01/mdefscs4/scratch/master_HiC_analyzer_allele/compartments"
        ...
        self.merged_validpairs = "/mnt/iusers01/jw01/mdefscs4/scratch/master_HiC_analyzer_allele/merged_validpairs"
        self.merged_sparsemat = "/mnt/iusers01/jw01/mdefscs4/scratch/master_HiC_analyzer_allele/merged_sparsemat"
        ...
        self.HiC_pro_ARIMA = "/mnt/jw01-aruk-home01/projects/functional_genomics/bin/HiC-Pro/HiC-Pro_3.0.0_install/HiC-Pro_3.0.0/HICPRO_config_Arima_HiC_masked.txt"
        self.keep_hicpro_align = True
